// Public asset: npx terser src/analytics.js --compress --mangle --output analytics.js --comments false
'use strict';
(() => {
  ...
  function loadSdk() {
    ...
    try {
      window.posthog.init(token, {
        ...
        capture_performance: false, advanced_disable_flags: true,
        mask_all_text: true, mask_all_element_attributes: true,
        cross_subdomain_cookie: false, secure_cookie: true,
